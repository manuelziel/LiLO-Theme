...
if ( ! function_exists( 'lilo_footer_text' ) ) :
	/**
	 * Displays footer text on footer line
	 */
	function lilo_footer_text() {
		if ( '' !== lilo_get_option( 'footer_text' ) || is_customize_preview() ) :
			?>

			<span class="footer-text">
				<?php echo do_shortcode( wp_kses_post( lilo_get_option( 'footer_text' ) ) ); ?> 
			</span>
...
if ( ! function_exists( 'lilo_credit_link' ) ) :
	/**
	 * Displays credit link on footer line
	 */
	function lilo_credit_link() {
		if ( true === lilo_get_option( 'credit_link' ) || is_customize_preview() ) :
			?>

			<span class="credit-link">
				<?php
				// translators: Theme Name and Link to ThemeZee.
				printf( esc_html__( 'WordPress Theme: %1$s by %2$s.', 'lilo' ),
					esc_html__( 'LiLO', 'lilo' ),
					'ThemeZee'
				);
				?>
			</span>
...
if ( ! function_exists( 'lilo_breadcrumbs' ) ) :
	/**
	 * Displays ThemeZee Breadcrumbs plugin
	 */
	function lilo_breadcrumbs() {
