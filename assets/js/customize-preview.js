...
( function( $ ) {
	...
	// Site Title checkbox.
	wp.customize( 'lilo_theme_options[site_title]', function( value ) {
	...
	wp.customize( 'lilo_theme_options[site_description]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	// Theme Layout.
	wp.customize( 'lilo_theme_options[theme_layout]', function( value ) {
		value.bind( function( newval ) {
			if ( 'wide' === newval ) {
	...
	// Box Shadow checkbox.
	wp.customize( 'lilo_theme_options[box_shadow]', function( value ) {
		value.bind( function( newval ) {
			if ( true === newval ) {
	...
	// Sidebar Position.
	wp.customize( 'lilo_theme_options[sidebar_position]', function( value ) {
		value.bind( function( newval ) {
	...
	// Blog Layout.
	wp.customize( 'lilo_theme_options[blog_layout]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'lilo_theme_options[read_more_link]', function( value ) {
		value.bind( function( to ) {
			$( 'a.more-link' ).text( to );
		} );
	} );
	...
	// Post Date checkbox.
	wp.customize( 'lilo_theme_options[meta_date]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'lilo_theme_options[meta_author]', function( value ) {
		value.bind( function( newval ) {
			if( ! $( 'body' ).hasClass( 'single-post' ) ) {
				if ( false === newval ) {
	...
	wp.customize( 'lilo_theme_options[meta_categories]', function( value ) {
		value.bind( function( newval ) {
			if( ! $( 'body' ).hasClass( 'single-post' ) ) {
				if ( false === newval ) {
	...
	wp.customize( 'lilo_theme_options[meta_comments]', function( value ) {
		value.bind( function( newval ) {
			if( ! $( 'body' ).hasClass( 'single-post' ) ) {
				if ( false === newval ) {
	...
	wp.customize( 'lilo_theme_options[single_meta_date]', function( value ) {
		value.bind( function( newval ) {
			if( $( 'body' ).hasClass( 'single-post' ) ) {
				if ( false === newval ) {
					$( 'body' ).addClass( 'date-hidden' );
	...
	wp.customize( 'lilo_theme_options[single_meta_author]', function( value ) {
		value.bind( function( newval ) {
			if( $( 'body' ).hasClass( 'single-post' ) ) {
				if ( false === newval ) {
					$( 'body' ).addClass( 'author-hidden' );
	...
	wp.customize( 'lilo_theme_options[single_meta_categories]', function( value ) {
		value.bind( function( newval ) {
			if( $( 'body' ).hasClass( 'single-post' ) ) {
				if ( false === newval ) {
					$( 'body' ).addClass( 'categories-hidden' );
	...
	wp.customize( 'lilo_theme_options[single_meta_comments]', function( value ) {
		value.bind( function( newval ) {
			if( $( 'body' ).hasClass( 'single-post' ) ) {
				if ( false === newval ) {
					$( 'body' ).addClass( 'comments-hidden' );
	...
	// Post Tags checkbox.
	wp.customize( 'lilo_theme_options[meta_tags]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'lilo_theme_options[post_navigation]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	// Footer textfield.
	wp.customize( 'lilo_theme_options[footer_text]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'lilo_theme_options[credit_link]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
